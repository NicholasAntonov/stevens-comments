	...
	exports['default'] = {
	  controller: function controller() {
	    var posts = _mithril2['default'].prop([]),
	        sortingByTop = _mithril2['default'].prop(false);
	  ...
	  view: function view(ctrl) {
	    return [_mithril2['default'].component(_wrapper2['default'], { main: (0, _mithril2['default'])('main.container', [_postBox2['default'], (0, _mithril2['default'])('ul', ctrl.posts().map(function (post, postPageIndex) {
	      ...
	      })), (0, _mithril2['default'])('.mode-switcher.z-depth-2', [(0, _mithril2['default'])('a.waves-effect.waves-green.btn-flat' + (ctrl.sortingByTop() ? '.green.lighten-2' : ''), { onclick: ctrl.sortByTop }, 'Top'), (0, _mithril2['default'])('a.waves-effect.waves-green.btn-flat' + (ctrl.sortingByTop() ? '' : '.green.lighten-2'), { onclick: ctrl.sortByNew }, 'New')])]) })];
	  }
	};
