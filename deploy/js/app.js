...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
	  ...
	  view: function view(ctrl) {
	    return [_mithril2['default'].component(_wrapper2['default'], { main: (0, _mithril2['default'])('main.container', ctrl.messages().map(function (message) {
