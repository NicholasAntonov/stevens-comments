...
/***/ function(module, exports, __webpack_require__) {
	...
	function check() {
	  _mithril2['default'].request({
	    ...
	    return console.log(loggedIn(JSON.parse(data)));
	  });
	}
