...
--
-- Host: localhost
-- Generation Time: Jul 05, 2015 at 01:19 AM
...
(1, 1, 1, 0, 'shiznit ma nizzle fames crazy that''s the shizzle egestizzle. Doggy tempor bizzle izzle. Aliquam erat fo shizzle. Vivamizzle tortor enizzle, break it down cool, things a, sure vizzle, arcu. Sheezy elizzle. Donizzle fermentum, est at pharetra sizzle, magna dope ultricizzle neque, nizzle mammasay mammasa mamma oo sa urna g', '2015-06-25 04:00:00', 1, 0, 0),
(2, 9, 1, 0, 'Praesent ghetto nisi quis justo doggy molestie. ', '2015-06-26 04:00:00', 0, 0, 0),
(3, 9, 2, 17, 'asdfasdf', '2015-07-02 04:00:00', 0, 0, 0),
(4, 9, 2, 18, 'asdfasdf', '2015-07-02 04:00:00', 1, 1, 1),
(5, 1, 10, 30, 'test', '2015-07-05 02:47:10', 0, 0, 0),
(6, 1, 10, 36, 'hawt', '2015-07-04 23:10:07', 0, 0, 0),
(7, 1, 4, 37, 'k', '2015-07-04 23:10:16', 0, 0, 0);
...
(3, 3, 7, 'testmessage', '2015-07-01 04:00:00', 0),
(4, 3, 9, 'testing123', '2015-07-01 04:00:00', 0),
(5, 18, 19, 'testmessage', '2015-07-02 04:00:00', 0),
(6, 18, 20, 'testmessage2', '2015-07-02 04:00:00', 1);
...
--
ALTER TABLE `comments`
  MODIFY `c_id` int(12) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `ownage`
  MODIFY `ownage_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=42;
--
-- AUTO_INCREMENT for table `posts`
--
ALTER TABLE `posts`
  MODIFY `p_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=133;
--
